...
all_data_plot<- function(df){
  ...
  p1 <- ggplot2::ggplot(df1) + ggplot2::aes(minutes, intensity)  + ggplot2::geom_line(aes(colour = cell_number)) + ggplot2::facet_grid(bio_rep ~ tech_rep) + geom_vline(xintercept = 10, linetype = "dotted")
  p2 <- ggplot2::ggplot(df2) + ggplot2::aes(minutes, intensity)  + ggplot2::geom_line(aes(colour = cell_number)) + ggplot2::facet_grid(bio_rep ~ tech_rep) + geom_vline(xintercept = 10, linetype = "dotted")
  p3 <- ggplot2::ggplot(df3) + ggplot2::aes(minutes, intensity)  + ggplot2::geom_line(aes(colour = cell_number)) + ggplot2::facet_grid(bio_rep ~ tech_rep) + geom_vline(xintercept = 10, linetype = "dotted")
  p4 <- ggplot2::ggplot(df4) + ggplot2::aes(minutes, intensity)  + ggplot2::geom_line(aes(colour = cell_number)) + ggplot2::facet_grid(bio_rep ~ tech_rep) + geom_vline(xintercept = 10, linetype = "dotted")
